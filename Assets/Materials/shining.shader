		...
		SubShader
		{
			...
			CGPROGRAM
				...
				fixed4 frag(v2f i) : COLOR
				{
					...
					fixed2 glowtex = i.texcoord;
					glowtex.x -= 0.04;
					glowtex.y -= 0.02;
					fixed4 col_glow = tex2D(_GlowTex, glowtex);
					...
					if (color.a == 0 && col_glow.a > 0)
					{
						col_glow.a *= frac(_Time * 100);
						color = color + col_glow;
					}
					return color;
				}
				ENDCG
